...
- [2 Structure of MATSIRO](#structure-of-matsiro)
  - [2.1 Overview of MATSIRO](#overview-of-matsiro)
    - [2.1.1 General structure](#general-structure)
    - [2.1.2 Internal variables of MATSIRO](#internal-variables-of-matsiro)
  - [2.2 Flux calculation section](#flux-calculation-section)
    - [2.2.1 Structure of the flux calculation section](#structure-of-the-flux-calculation-section)
    - [2.2.2 Input variables of the flux calculation section](#input-variables-of-the-flux-calculation-section)
    - [2.2.3 Output variables of the flux calculation section](#output-variables-of-the-flux-calculation-section)
  - [2.3 Land surface integration section](#land-surface-integration-section)
    - [2.3.1 Structure of land surface integration section](#structure-of-land-surface-integration-section)
    - [2.3.2 Input variables of land surface integration section](#input-variables-of-land-surface-integration-section)
    - [2.3.3 Output variables of land surface integration section](#output-variables-of-land-surface-integration-section)
  - [2.4 External parameters](#external-parameters)
    - [2.4.1 External parameters given by map](#external-parameters-given-by-map)
    - [2.4.3 External parameters given by table for each soil type](#external-parameters-given-by-table-for-each-soil-type)
- [3 MATBND Boundary Value Submodel](#matbnd-boundary-value-submodel)
  - [3.1 Vegetation type parameter set](#vegetation-type-parameter-set)
  - [3.2 Calculation of radiation parameters](#calculation-of-radiation-parameters)
    - [3.2.1 Calculation of　ground surface (forest floor) albedo](#calculation-of-ground-surface-forest-floor-albedo)
    - [3.2.2 Calculation of canopy albedo and transmissivity](#calculation-of-canopy-albedo-and-transmissivity)
    - [3.2.3 Calculation of surface radiation flux, etc.](#calculation-of-surface-radiation-flux-etc)
- [3.3 Calculation of turbulence parameter (bulk coefficient)](#calculation-of-turbulence-parameter-bulk-coefficient)
    - [3.3.1 Calculation of roughness with respect to momentum and heat](#calculation-of-roughness-with-respect-to-momentum-and-heat)
    - [3.3.2 Calculation of bulk coefficient with respect to momentum and heat](#calculation-of-bulk-coefficient-with-respect-to-momentum-and-heat)
    - [3.3.3 Calculation of bulk coefficient with respect to vapor](#calculation-of-bulk-coefficient-with-respect-to-vapor)
  - [3.4 Calculation of stomatal resistance](#calculation-of-stomatal-resistance)
    - [3.4.1 Calculation of soil moisture stress factor](#calculation-of-soil-moisture-stress-factor)
    - [3.4.2 Calculation of amount of photosynthesis](#calculation-of-amount-of-photosynthesis)
    - [3.4.3 Calculation of stomatal resistance (2)](#calculation-of-stomatal-resistance-2)
    - [3.4.4 Calculation of ground surface evaporation resistance](#calculation-of-ground-surface-evaporation-resistance)
- [4. MATSFC Surface Submodel](#matsfc-surface-submodel)
  - [4.1 Calculation of surface turbulent fluxes](#calculation-of-surface-turbulent-fluxes)
  - [4.2 Calculation of heat conduction fluxes](#calculation-of-heat-conduction-fluxes)
  - [4.3 Solution of energy balance at ground surface and canopy](#solution-of-energy-balance-at-ground-surface-and-canopy)
    - [4.3.1 Energy balance at ground surface and canopy](#energy-balance-at-ground-surface-and-canopy)
    - [4.3.2 Case 1: When there is no melting at the ground surface](#case-1-when-there-is-no-melting-at-the-ground-surface)
    - [4.3.3 Case 2: When there is melting at the ground surface](#case-2-when-there-is-melting-at-the-ground-surface)
    - [4.3.4 Conditions for solutions](#conditions-for-solutions)
    - [4.3.5 Updating of ground surface and canopy temperatures](#updating-of-ground-surface-and-canopy-temperatures)
    - [4.3.6 Updating of flux values](#updating-of-flux-values)
- [5 MATCNW Canopy Water Balance Submodel](#matcnw-canopy-water-balance-submodel)
  - [5.1 Diagnosis of canopy water phase](#diagnosis-of-canopy-water-phase)
  - [5.2 Prognosis of canopy water](#prognosis-of-canopy-water)
    - [5.2.1 Evaporation (sublimation) of canopy water](#evaporation-sublimation-of-canopy-water)
    - [5.2.2 Interception of precipitation by the canopy](#interception-of-precipitation-by-the-canopy)
    - [5.2.3 Dripping of the canopy water](#dripping-of-the-canopy-water)
    - [5.2.4 Updating and melting of canopy water](#updating-and-melting-of-canopy-water)
  - [5.3 Fluxes given to the soil, snow, and runoff process](#fluxes-given-to-the-soil-snow-and-runoff-process)
- [6 MATSNW Snow Submodel](#matsnw-snow-submodel)
  - [6.1 Diagnosis of snow-covered ratio](#diagnosis-of-snow-covered-ratio)
  - [6.2 Vertical division of snow layers](#vertical-division-of-snow-layers)
  - [6.3 Calculation of snow water equivalent](#calculation-of-snow-water-equivalent)
    - [6.3.1 Sublimation of snow](#sublimation-of-snow)
    - [6.3.2 Snowmelt](#snowmelt)
    - [6.3.3 Freeze of snowmelt water and rainfall in snow](#freeze-of-snowmelt-water-and-rainfall-in-snow)
    - [6.3.4 Snowfall](#snowfall)
    - [6.3.5 Redivision of snow layer and rediagnosis of temperature](#redivision-of-snow-layer-and-rediagnosis-of-temperature)
  - [6.4 Calculation of snow heat conduction](#calculation-of-snow-heat-conduction)
    - [6.4.1 Snow heat conduction equations](#snow-heat-conduction-equations)
    - [6.4.2 Case 1: When snowmelt does not occur in the uppermost layer](#case-1-when-snowmelt-does-not-occur-in-the-uppermost-layer)
  - [6.5 Glacier formation](#glacier-formation)
  - [6.6 Fluxes given to the soil or the runoff process](#fluxes-given-to-the-soil-or-the-runoff-process)
  - [6.7 Calculation of snow albedo](#calculation-of-snow-albedo)
- [7 MATROF Runoff Submodel](#matrof-runoff-submodel)
  - [7.1 Outline of TOPMODEL](#outline-of-topmodel)
  - [7.2 Application of TOPMODEL assuming simplified topography](#application-of-topmodel-assuming-simplified-topography)
  - [7.3 Calculation of runoff](#calculation-of-runoff)
    - [7.3.1 Estimation of mean water table depth](#estimation-of-mean-water-table-depth)
    - [7.3.2 Calculation of groundwater runoff](#calculation-of-groundwater-runoff)
    - [7.3.3 Calculation of surface runoff](#calculation-of-surface-runoff)
  - [7.4 Water flux given to soil](#water-flux-given-to-soil)
- [8 MATGND Soil Submodel](#matgnd-soil-submodel)
  - [8.1 Calculation of soil heat conduction](#calculation-of-soil-heat-conduction)
    - [8.1.1 Soil heat conduction equations](#soil-heat-conduction-equations)
    - [8.1.2 Solution of heat conduction equations](#solution-of-heat-conduction-equations)
  - [8.2 Calculation of soil moisture movement](#calculation-of-soil-moisture-movement)
    - [8.2.1 Soil moisture movement equations](#soil-moisture-movement-equations)
    - [8.2.2 Solution of soil moisture movement equations](#solution-of-soil-moisture-movement-equations)
  - [8.3 Phase change of soil moisture](#phase-change-of-soil-moisture)
    - [8.3.1 Ice sheet process](#ice-sheet-process)
...
In program terms, the entry of the flux calculation section LNDFLX and the entry of the land surface integration section LNDSTP are contained in the driver program (matdrv.F), and subroutines for the various processes required are respectively called from these entries. LNDFLX and LNDSTP share the same internal variables of MATSIRO.
