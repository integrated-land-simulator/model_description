...
$$
the mositure(matric) potential $\psi$ is defined in L58, the upper boundary of the unsaturated layer $k_{WT}$ is difined in L65, the mean water table depth $\overline{z}$ is calculated through above equation in L163
...
$$
 \overline{z} = z_{g(k_{WT}-1/2)} - \psi_{k_{WT}}
$$
the mositure(matric) potential $\psi$ is defined in L77, the upper boundary of the unsaturated layer $k_{WT}$ is difined in L84, the mean water table depth $\overline{z}$ is calculated through above equation in L199
### 9.3.2 Calculation of groundwater runoff
### 9.3.3 Calculation of surface runoff
